...
import com.codewithparas.bookshope.Models.myproductmodel;
...
public class MyProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FirestoreRecyclerAdapter<myproductmodel, com.codewithparas.bookshope.MyProductActivity.ProductsViewHolder1>(options) {
            @Override
            protected void onBindViewHolder(@NonNull com.codewithparas.bookshope.MyProductActivity.ProductsViewHolder1 holder, int position, @NonNull final myproductmodel model) {
                ...
                holder.myproduct_remove.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(com.codewithparas.bookshope.MyProductActivity.this,"Button clicked",Toast.LENGTH_SHORT).show();
                         db.collection("users").document(currentuserID).collection("Products").document(model.getPid()+currentuserID).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                             ...
                             public void onSuccess(Void unused) {
                                 db.collection("Products Category").document(model.getPid()+currentuserID).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                     @Override
                                     public void onSuccess(Void unused) {
                                         Toast.makeText(com.codewithparas.bookshope.MyProductActivity.this,"Product Successfully Removed",Toast.LENGTH_SHORT).show();
                                     }
                                 })
                                         .addOnFailureListener(new OnFailureListener() {
                                             @Override
                                             public void onFailure(@NonNull @NotNull Exception e) {
                                                 Toast.makeText(com.codewithparas.bookshope.MyProductActivity.this,"Try Again Later",Toast.LENGTH_SHORT).show();
                                             }
                                         });
                             }
                         })
            ...
            @NonNull
            @Override
            public com.codewithparas.bookshope.MyProductActivity.ProductsViewHolder1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                ...
                db.collection("users")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(com.codewithparas.bookshope.SettingActivity.this, "Registered Succesfully", Toast.LENGTH_LONG).show();
                                Intent i=new Intent(com.codewithparas.bookshope.SettingActivity.this,DashBoard.class);
                                startActivity(i);
                            }
                        });
            }
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            Toast.makeText(com.codewithparas.bookshope.SettingActivity.this, "set username ", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

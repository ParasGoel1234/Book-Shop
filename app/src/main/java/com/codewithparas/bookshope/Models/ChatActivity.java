package com.codewithparas.bookshope.Models;
...
import com.codewithparas.bookshope.R;
import com.codewithparas.bookshope.specificchat;
...
//                Picasso.get().load(uri).into(mimageviewofuser);
                ...
                noteViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent=new Intent(com.codewithparas.bookshope.Models.ChatActivity.this,
                                specificchat.class);

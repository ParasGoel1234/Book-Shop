...
import com.codewithparas.bookshope.Models.Mainmodel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(com.codewithparas.bookshope.DashBoard.this,AddProductActivity.class);
                startActivity(i);
            }
        });
...
//            startActivity(intent);
            ...
            Intent intent = new Intent(com.codewithparas.bookshope.DashBoard.this, MyProductActivity.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_mychats) {
            Intent intent = new Intent(com.codewithparas.bookshope.DashBoard.this, ChatActivity.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_cart) {
            Intent intent = new Intent(com.codewithparas.bookshope.DashBoard.this, CartActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_settings) {
            Intent intent = new Intent(com.codewithparas.bookshope.DashBoard.this, SettingActivity.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_logout) {
            FirebaseAuth.getInstance().signOut();
            Intent intent = new Intent(com.codewithparas.bookshope.DashBoard.this, Otp1.class);
//            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
    ...
    protected void onStart() {
        ...
        noteref.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot,
                ...
                if (e != null) {
                    Toast.makeText(com.codewithparas.bookshope.DashBoard.this, e.toString(), Toast.LENGTH_LONG).show();
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    Toast.makeText(com.codewithparas.bookshope.DashBoard.this, "Set username first", Toast.LENGTH_LONG).show();
    ...
    private void SendUserToSettingActivity() {
        ...
        Intent i = new Intent(com.codewithparas.bookshope.DashBoard.this, SettingActivity.class);
        startActivity(i);
    }

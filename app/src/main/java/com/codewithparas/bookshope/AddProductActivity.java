    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputProductImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder b = new AlertDialog.Builder(com.codewithparas.bookshope.AddProductActivity.this);
        ...
        switch (requestCode) {
            case pe: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(com.codewithparas.bookshope.AddProductActivity.this, "Permission denied...", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(com.codewithparas.bookshope.AddProductActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        ...
        db.collection("Products Category").document(productRandomKey+CurrentUserId).set(productMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(com.codewithparas.bookshope.AddProductActivity.this, "Your Product Add Successfully", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                        Intent i = new Intent(com.codewithparas.bookshope.AddProductActivity.this, DashBoard.class);
                        startActivity(i);

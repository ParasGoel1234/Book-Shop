...
import com.codewithparas.bookshope.Models.cartmodel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteref.get()
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.codewithparas.bookshope.CartActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            protected void onBindViewHolder(@NonNull final ProductsViewHolder holder, int position, @NonNull final cartmodel model) {
                ...
                holder.cart_remove.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(com.codewithparas.bookshope.CartActivity.this, "Product Removed Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
                                        ...
                                        db.collection("Ordered By"+ currentuserID).document(model.getPid()).set(productMap)
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        Toast.makeText(com.codewithparas.bookshope.CartActivity.this, "Ordered Placed Successfully", Toast.LENGTH_LONG).show();
                                                        loadingBar.dismiss();
                                                        Intent i = new Intent(com.codewithparas.bookshope.CartActivity.this, DashBoard.class);
                                                        startActivity(i);
                                                    }
                                                }).addOnFailureListener(new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(com.codewithparas.bookshope.CartActivity.this, "Error" + e.toString(), Toast.LENGTH_LONG).show();
...
//                        }
                                        ...
                                        Toast.makeText(com.codewithparas.bookshope.CartActivity.this,"Product is Removed By Owner",Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Toast.makeText(com.codewithparas.bookshope.CartActivity.this,"Try Again Later",Toast.LENGTH_LONG).show();

...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this,ProductID.substring(23),Toast.LENGTH_SHORT).show();
        ...
        ProductImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(com.codewithparas.bookshope.ProductDetailActivity.this, ImageActivity.class);
...
//        apiService = Client.getClient("https://fcm.googleapis.com/").create(APIService.class);
        ...
        noteref.get()
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this, "ERROR "+ e.toString(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        noteref2.get()
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this, "Product Not Exist "+ e.toString(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View view) {
                ...
                db.collection("users").document(currentuserID).collection("chat").document(ProductID.substring(23)).set(chatMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                           Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this,"You Can now chat with owner in your Chat Section",Toast.LENGTH_SHORT).show();
                        }
                    });
                ...
                db.collection("users").document(ProductID.substring(23)).collection("chat").document(currentuserID).set(chatMap2)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this,"succcessfully",Toast.LENGTH_SHORT).show();
            ...
            db.collection("CART OF" + currentuserID).document(productName).set(productMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this, "Add to cart successful", Toast.LENGTH_LONG).show();
                            loadingBar.dismiss();
                            Intent i = new Intent(com.codewithparas.bookshope.ProductDetailActivity.this, CartActivity.class);
                            startActivity(i);
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this, "Error" + e.toString(), Toast.LENGTH_LONG).show();

                }
            });
            // Toast.makeText(ProductDetailActivity.this, "Order Placed Successfully", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
...
//                            startActivity(i);
            ...
            db.collection("Ordered By" + currentuserID).document(productRandomKey).set(productMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(com.codewithparas.bookshope.ProductDetailActivity.this, "Ordered Placed Successfully", Toast.LENGTH_LONG).show();
                            loadingBar.dismiss();
                            Intent i = new Intent(com.codewithparas.bookshope.ProductDetailActivity.this, DashBoard.class);
                            startActivity(i);
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
